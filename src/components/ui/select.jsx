  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "p-1 overflow-y-auto",
          // Mobile-safe max height: never exceed 40vh or 320px
...
const SelectItem = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-2 pl-3 pr-9 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 min-h-[44px]",
      className
    )}
    {...props}>
