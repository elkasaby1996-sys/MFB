  ...
  "fixed z-50 gap-4 bg-background shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        bottom:
          "inset-x-0 bottom-0 border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom max-h-[95dvh] sm:max-h-[85dvh] flex flex-col p-0 overflow-hidden safe-bottom safe-x keyboard-sheet overscroll-contain",
...
const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-2 text-center sm:text-left px-6 pt-6 pb-4 flex-shrink-0 border-b border-slate-800", className)}
    {...props} />
)
